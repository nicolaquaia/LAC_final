...
def main():
    ...
    master_htc = './_master/Group1_redesign_C1.htc'
    opt_path = './data/Group1_redesign_flex.opt'
    wsps = range(5, 25)  # wind speed range
    htc_dir = './htc_turb_C1/'  # top-level folder to save htc files (can be path to gbar!)
    res_dir = './res_turb_C1/'  # where HAWC2 should save res files, relative to its working directory
